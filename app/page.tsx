...
import { MapPin, Search, Users, ChevronRight, BookOpen, Coffee, MessageCircle, GraduationCap, Briefcase, Star, Zap, Globe, Lightbulb, Menu } from "lucide-react"
...
export default function HomePage() {
  ...
  const recentProfiles = [
    { name: "Alex Johnson", major: "Computer Science", avatar: "https://i.pravatar.cc/150?img=1" },
    { name: "Samantha Lee", major: "Biology", avatar: "https://i.pravatar.cc/150?img=2" },
    { name: "Michael Chen", major: "Economics", avatar: "https://i.pravatar.cc/150?img=3" },
    { name: "Emily Davis", major: "Psychology", avatar: "https://i.pravatar.cc/150?img=4" },
  ]
  ...
  const imageUrls = [
    "https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8c3R1ZGVudHN8ZW58MHx8MHx8fDA%3D",
    "https://images.unsplash.com/photo-1627556704302-624286467c65?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8c3R1ZGVudHN8ZW58MHx8MHx8fDA%3D",
    "https://images.unsplash.com/photo-1629904853716-f0bc54eea481?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fHN0dWRlbnRzfGVufDB8fDB8fHww",
    "https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fHN0dWRlbnRzfGVufDB8fDB8fHww",
  ]
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-200 md:text-xl">
                    Discover, collaborate, and grow with fellow students in your area. Join GenZHub today!
                  </p>
                </div>
        ...
        <section className="w-full flex justify-center py-6 md:py-10 lg:py-10 bg-gradient-to-b from-blue-100 to-purple-100">
          <div className="container px-4 md:px-6">
            ...
            >
              ...
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-purple-800">Recently Active Profiles</h2>
              <p className="max-w-[900px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Discover students who have been actively connecting on our platform. These profiles are gaining attention!
              </p>
            </motion.div>
            <motion.div
                  ...
                  <Card className="overflow-hidden bg-white bg-opacity-50 backdrop-blur-lg hover:shadow-lg transition-shadow duration-300">
                    <CardContent className="p-6">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <h3 className="font-semibold text-purple-800">{profile.name}</h3>
